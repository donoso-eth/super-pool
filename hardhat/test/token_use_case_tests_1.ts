    ...
    users = [
      ...
      },
      {
        ...
        expected: { realTimeBalance: BigNumber.from(5).mul(10).mul(PRECISSION), shares: BigNumber.from(50),
          tokenBalance:utils.parseEther('10').sub(BigNumber.from(50)).sub(BigNumber.from(+fromUser2Stream.deposit)) },
      },
    ];
    ...
    users = [
      ...
      },
      {
        ...
        expected: { realTimeBalance: BigNumber.from(178947365), shares: BigNumber.from(100),
          tokenBalance:utils.parseEther('10').sub(BigNumber.from(100)).sub(BigNumber.from(+fromUser2Stream.deposit)) },
      },
    ];
    ...
    users = [
      {
        ...
        expected: { 
          ...
          tokenBalance:utils.parseEther('10').sub(+fromUser1Stream.deposit).sub(BigNumber.from(20)) 
         },
      },
      {
        name: 'User2',
        ...
        expected: { realTimeBalance: BigNumber.from(401361155), 
          ...
          tokenBalance:utils.parseEther('10').sub(BigNumber.from(150)).sub(BigNumber.from(+fromUser2Stream.deposit)) 
    ...
    users = [
      {
        ...
        expected: { realTimeBalance: BigNumber.from(295810516), shares: BigNumber.from(130)
         ,  tokenBalance:utils.parseEther('10').sub(+fromUser1Stream.deposit).sub(BigNumber.from(130)) }
      ...
      },
      {
        ...
        expected: { realTimeBalance: BigNumber.from(534189435), shares: BigNumber.from(200),
          tokenBalance:utils.parseEther('10').sub(BigNumber.from(200)).sub(BigNumber.from(+fromUser2Stream.deposit)) },
      },
    ];
    ...
    users = [
      {
        ...
        expected: { realTimeBalance: BigNumber.from(495597928), shares: BigNumber.from(190)
         ,  tokenBalance:utils.parseEther('10').sub(+fromUser1Stream.deposit).sub(BigNumber.from(190)) }
      ...
      },
      {
        ...
        tokenBalance:utils.parseEther('10').sub(BigNumber.from(250)).sub(BigNumber.from(+fromUser2Stream.deposit)) },
      },
    ];
    ...
    users = [
      {
        ...
        expected: { realTimeBalance: BigNumber.from(622080910), shares: BigNumber.from(250)
         ,  tokenBalance:utils.parseEther('10').sub(BigNumber.from(250)).sub(BigNumber.from(+fromUser1Stream.deposit)) }
    ...
    users = [
      {
        ...
        expected: { realTimeBalance: BigNumber.from(711036360), shares: BigNumber.from(310)
         ,  tokenBalance:utils.parseEther('10').sub(BigNumber.from(310)).sub(BigNumber.from(+fromUser1Stream.deposit)) }
      ...
      },
      {
        ...
        tokenBalance:utils.parseEther('10').sub(BigNumber.from(300)).sub(BigNumber.from(+fromUser2Stream.deposit)).add(BigNumber.from(80)) },
      },
    ];
    ...
    users = [
      {
        ...
        expected: { realTimeBalance: BigNumber.from(797649946), shares: BigNumber.from(370)
         ,  tokenBalance:utils.parseEther('10').sub(BigNumber.from(370)).sub(BigNumber.from(+fromUser1Stream.deposit)) }

      },
      {
        name: 'User2',
        result: { realTimeBalance: user2RealtimeBalance, shares: user2Shares ,tokenBalance:user2Balance  },
        expected: { realTimeBalance: BigNumber.from(631430196), shares: BigNumber.from(200),
        tokenBalance:utils.parseEther('10').sub(BigNumber.from(340)).sub(BigNumber.from(+fromUser2Stream.deposit)).add(BigNumber.from(80)).add(BigNumber.from(200)) },
      },
    ];
    ...
    users = [
      {
        name: 'User1',
        result: { realTimeBalance: user1RealtimeBalance, shares: user1Shares, tokenBalance:user1Balance },
        expected: { realTimeBalance: BigNumber.from(797649946), shares: BigNumber.from(430)
         ,  tokenBalance:utils.parseEther('10').sub(BigNumber.from(370)).sub(BigNumber.from(+fromUser1Stream.deposit)) }
      ...
      },
      {
        name: 'User2',
        result: { realTimeBalance: user2RealtimeBalance, shares: user2Shares ,tokenBalance:user2Balance  },
        expected: { realTimeBalance: BigNumber.from(631430196), shares: BigNumber.from(240),
        tokenBalance:utils.parseEther('10').sub(BigNumber.from(340)).add(BigNumber.from(80)).add(BigNumber.from(200)) },
      },
    ];
