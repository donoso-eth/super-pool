...
@Component({
  selector: 'app-redeem-flow',
  templateUrl: './redeem-flow.component.html',
  styleUrls: ['./redeem-flow.component.scss']
})
export class RedeemFlowComponent  extends DappBaseComponent implements OnInit {
  stopCondition = [
 ...
 async  startFlow() {
    ...
    this.store.dispatch(Web3Actions.chainBusyWithMessage({message: {body:'Yeap... you get your stream back!!', header:'Un momento'}}))
