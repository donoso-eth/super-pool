...
export class DappInjector implements OnDestroy {
 ...
 ///// ---------  importing local priv_keys
  ...
  private async contractInitialization() {
    ...
    PoolMetadata.address = '0xdf0e3831D462B16BD8F11A0FbcA61CF2DAEAEB0d';//0x82ac8E2Be327AEF1E978BdA95202Ce05253a488e'//resolver.pool;//  '0xf1872346caF0eBf567bd9704AE2B661c8D034998';
